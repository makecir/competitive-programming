...
int main(){
	...
	// rep(i,30)puta(h_cost[i]);
	// puta("");
	// rep(i,29)puta(v_cost[i]);
	// puta("");
	// ll sh=0,sv=0;
	// rep(i,30){
	// 	rep(j,29)cout<<(h_cost[i][j]-h_correct[i][j])<<" ",sh+=(h_cost[i][j]-h_correct[i][j]);
	// 	cout<<endl;
	// }
	// puta("");
	// rep(i,29){
	// 	rep(j,30)cout<<(v_cost[i][j]-v_correct[i][j])<<" ",sv+=(v_cost[i][j]-v_correct[i][j]);
	// 	cout<<endl;
	// }
	// puta("");
	// puta(sh);
